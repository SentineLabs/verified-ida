...
ANALYST_CAPABILITIES: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "requires_target": False,
        "example": {"task_type": "list_functions", "prefix": "Grace"},
    },
    {
        "name": "inspect_addr",
    ...
    },
    {
        ...
        "requires_target": False,
        "example": {"task_type": "list_local_types", "prefix": "Grace"},
    },
    {
        "name": "inspect_struct",
        "description": "Inspect one named struct/local type and its known members.",
        "aliases": ("struct_info", "type_info", "inspect_type"),
        "requires_target": True,
        "example": {"task_type": "inspect_struct", "target": "GraceObject"},
    },
    {
        "name": "read_struct",
        "description": "Read a named struct/local type in declaration-like form with members and offsets.",
        "aliases": ("read_type", "render_struct", "struct_declaration"),
        "requires_target": True,
        "example": {"task_type": "read_struct", "target": "GraceObject"},
    },
    {
        "name": "xrefs_to_field",
        "description": "Find code references that appear to access a struct/member offset or field-like displacement.",
        "aliases": ("field_xrefs", "xrefs_to_struct_field", "xrefs_to_member"),
        "requires_target": True,
        "example": {"task_type": "xrefs_to_field", "target": "GraceObject", "offset": "0x28"},
    },
    {
        "name": "find_paths",
